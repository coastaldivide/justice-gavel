...
describe('COMP2. FE Components — All 17 Documented', () => {
  ...
  test('COMP2-02: EmergencyStrip.tsx + FloatingSOSButton — crisis UX', async () => {
    const fs = await import('fs');
    const s1 = fs.readFileSync('/tmp/JG_fresh/frontend/src/components/EmergencyStrip.tsx','utf8');
    const s2 = fs.readFileSync('/tmp/JG_fresh/frontend/src/components/FloatingSOSButton.tsx','utf8');
