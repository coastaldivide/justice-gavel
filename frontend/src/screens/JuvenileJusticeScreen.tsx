  ...
  return (
    ...
    >
      ...
      <View style={[styles.header, { backgroundColor: colors.navy }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.bgCard }]}>Juvenile Justice</Text>
        <Text style={[styles.headerSub, { color: colors.steel }]}>Rights in the juvenile system</Text>
      </View>
