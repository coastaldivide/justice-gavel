...
const styles = (colors: any) => StyleSheet.create({
  ...
  stepNum:            { width: 22, height: 22, borderRadius: 11, backgroundColor: colors.primary, textAlign: 'center', color: colors.bg, fontWeight: '700', fontSize: 12, lineHeight: 22, marginRight: 10 },
