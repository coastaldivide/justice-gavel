  ...
  return (
    ...
    >
      ...
      <View style={[styles.header, { backgroundColor: colors.navy }]}>
        <Text style={{ fontSize: 32 }} maxFontSizeMultiplier={1.4}>🧠</Text>
        <Text style={[styles.headerTitle, { color: colors.bgCard }]} maxFontSizeMultiplier={1.4}>Mental Health Diversion</Text>
        <Text style={[styles.headerSub, { color: colors.steel }]} maxFontSizeMultiplier={1.4}>Diversion programs & rights</Text>
      </View>
...
export default React.memo(MentalHealthDiversionScreen);
